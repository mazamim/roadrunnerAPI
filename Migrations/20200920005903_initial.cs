        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPunch = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "RateCardTickets",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RateCardId = table.Column<int>(nullable: false),
                    TicketId = table.Column<int>(nullable: false),
                    Qty = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateCardTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RateCardTickets_RateCards_RateCardId",
                        column: x => x.RateCardId,
                        principalTable: "RateCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RateCardTickets_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id"
                        );
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RateCardTickets_RateCardId",
                table: "RateCardTickets",
                column: "RateCardId");

            migrationBuilder.CreateIndex(
                name: "IX_RateCardTickets_TicketId",
                table: "RateCardTickets",
                column: "TicketId");
